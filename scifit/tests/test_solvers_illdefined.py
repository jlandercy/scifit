...
class StrangeSOExpCosData:
    xdata = np.array([[
        0.10009766, 0.14990234, 0.19995117, 0.25, 0.30004883,
        0.35009766, 0.39990234, 0.44995117, 0.5, 0.55004883,
        0.60009766, 0.64990234, 0.69995117, 0.75, 0.80004883,
        0.85009766, 0.89990234, 0.94995117, 1., 1.05004883,
        1.10009766, 1.14990234, 1.19995117
    ]]).T
    ydata = np.array([
        0.91363212, -0.13781298, -1.06832094, -0.10673643, -0.16275403,
...
class StrangeSOExpCosSolverRegressionDataset(StrangeSOExpCosData, StrangeSOExpCosSolverRegression, TestCase):
    configuration = {"p0": np.array([-5.0, 1.0, 0.15, 1.0])}


class StrangeSOExpCosSolverRegressionSynthetic(StrangeSOExpCosSolverRegression, TestCase):
...
class SOExpCosSolverRegressionDataset(StrangeSOExpCosData, StrangeSOExpCosSolverRegression, TestCase):
